    ...
    <table class="table table-bordered table-hover">
       ...
       ?>
              ...
              <tr>
                  ...
                  <td><a onClick="javascript:return confirm('Estas seguro que lo quieres eliminar?');" class="btn btn-danger" href='categorias.php?eliminar=<?php echo $datos[$i]["id_categoria"]?>'><i class="fa fa-trash"></i>  Eliminar</a></td>
